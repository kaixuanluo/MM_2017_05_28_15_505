...
public class MainFrgAdvPresenter extends BaseListPresenter<MainFrgAdvResult.MainFrgAdv, MainFrgAdvResult> {

    public MainFrgAdvPresenter(BaseListStatus<MainFrgAdvResult.MainFrgAdv> baseListStatus,
...
//        Observable<MainFrgAdvResult> obv = MainFrgAdvModule.getMainFrgAdvService().advList3(page, 20, "hg","fp1");
        Observable<MainFrgAdvResult> obv = MainFrgAdvModule.getMainFrgAdvService().advList2(page, 20);
        baseLoadingObv(obv);
    }
}
