 ...
 * Version 1.0
 */
public class BaseLoadingPresenter<DATA extends BaseLoadingResult> extends BasePresenter implements BaseLoadingStatus<DATA> {
    ...
    protected void baseLoadingObv(Observable<DATA> obv) {
