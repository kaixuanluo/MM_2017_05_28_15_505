            ...
            public void onItemClick(ViewHolder vh) {
                ...
                if (baseHFAdapter.isHeaderViewPos(vh.getAdapterPosition())) {
                    ...
                    if (mOnRecyclerViewItemClickListener != null) {
                        mOnRecyclerViewItemClickListener.onItemClick(vh.getAdapterPosition() - baseHFAdapter.getHeadersCount());
                    }
                }
            }
            ...
            public void onItemLongClick(ViewHolder vh) {
                ...
                if (baseHFAdapter.isHeaderViewPos(vh.getAdapterPosition())) {
                    ...
                    if (mOnRecyclerViewItemLongClickListener != null) {
                        mOnRecyclerViewItemLongClickListener.onItemLongClick(vh.getAdapterPosition() - baseHFAdapter.getHeadersCount());
                    }
                }
            }
        };
